...
/**
 * Base SyncJobService that sync leaderboard data and coding statistics.
 */
/*
 * Note: In the previous project I mentioned to use {@link android.content.AbstractThreadedSyncAdapter}
 * to sync leaderboard, but I've used {@link FirebaseJobDispatcher} instead.
 */
